...
router.get('/load/:username', (req, res) => {
    ...
    User.findOne({ username: username }, (err, user) => {
        if (err)
            return console.log(
                `MESSAGE: Error in finding such user ERROR: ${err}`,
            );
        ...
        User.find()
            ...
            .then(users => {
                ...
                Slot.findOne({ slotLetter: 'a' }, (err, slot) => {
                    if (err)
                        return console.log(
                            `MESSAGE: Error in finding slot ERROR: ${err}`,
                        );
