...
function updateTime() {
    ...
    Slot.find({})
        ...
        .exec((err, slots) => {
            if (err)
                return console.log(
                    `MESSAGE: Error in UPDATING slot TIME ERROR: ${err}`,
                );
            ...
            slots.forEach(slot => {
                ...
                if (slot.state === 'reserved' || slot.state === 'occupied') {
                    ...
                    if (
                        slot.parokya.reservation.remainingTime.hour <= 0 &&
                        ...
                        if (slot.state === 'reserved') {
                            ...
                            if (
                                ...
                                if (
                                    slot.parokya.balance >=
                                    slot.slotRate.ratePerMin
                                ) {
                                    slot.parokya.balance -=
                                        slot.slotRate.ratePerMin;
                                } else {
